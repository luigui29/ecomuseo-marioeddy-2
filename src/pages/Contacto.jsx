...
const Contacto = () => {
  ...
  return (
    <div className='container py-5'> {/* Contenedor principal con padding vertical */}
      <h2 className='text-center mb-4 display-4 fw-bold text-primary'>Contacto</h2> {/* Título centrado, más grande, negrita y color primario */}
      <p className='text-center mb-5 lead text-muted'>
        ¿Tienes alguna pregunta o quieres colaborar? ¡Nos encantaría saber de ti!
      </p>

      <div className='row justify-content-center'> {/* Fila para organizar el contenido en columnas */}
        {/* Sección de Información de Contacto */}
        <div className='col-lg-5 col-md-8 mb-4'> {/* Columna para información de contacto, responsiva */}
          <div className='card shadow-sm h-100'> {/* Tarjeta con sombra y altura completa */}
            <div className='card-body'>
              <h3 className='card-title text-center mb-4 text-secondary'>Nuestra Información</h3> {/* Título de la tarjeta */}
              ...
              <div className='text-center mt-4'> {/* Centra los enlaces sociales */}
                <h3 className='mb-3 text-secondary'>Síguenos</h3>
